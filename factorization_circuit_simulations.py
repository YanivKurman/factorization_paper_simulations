...
if build_circuit:
    ...
    analyze(logical_ex, p_vec, d_vec, task_name='fact_circuit_d=9', post_selection=False)
    analyze(logical_ex, p_vec, d_vec, task_name='fact_circuit_d=9', post_selection=True)
else:
