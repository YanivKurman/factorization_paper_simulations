...
The analyze function runs the Monte-Carlo simulations.
The parameters max_shots and max_errors can be reduced to speed up simulations.
...
Define or modify logical circuits in logical_level_circuit.py.

Compile IR to physical circuits using compiler.py.

Run simulations via factorization_circuit_simulations.py.

Analyze results with analyze_circuit.py.

Generate figures using plot_results.py or decoding_task_plots.py.